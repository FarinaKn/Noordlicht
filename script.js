...
function applyLang(lang) {
  ...
  if (mapIframe) {
    const src = mapIframe.getAttribute('data-src-' + lang);
...
(function scatterIcons() {
  ...
  const pageLayer = document.querySelector('.js-icons-page');
  if (pageLayer) {
    // Use full scroll height so icons cover the whole page
    const totalH = document.documentElement.scrollHeight;
    pageLayer.style.height = totalH + 'px';
    populate(pageLayer);
  }
})();
